...
const AboutSection = () => {
  ...
  const coreValues = [
    { 
      ...
      description: "Pushing boundaries with creative solutions for tomorrow's challenges."
    },
    { 
      name: "Simplicity", 
      icon: "/Images/Who4.png",
      description: "Complex problems, elegant solutions. We believe in keeping things clear and effective."
    },
    { 
      name: "Personalization", 
      icon: "/Images/Who1.png",
      description: "Tailored approaches that reflect your unique business needs and goals."
    },
    { 
      name: "Collaboration", 
